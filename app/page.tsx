    ...
    <main className="min-h-screen bg-gradient-to-b from-stone-50 via-amber-50 to-stone-100 dark:from-stone-950 dark:via-stone-900 dark:to-stone-950 relative overflow-x-hidden text-foreground">
      ...
      <div className="relative z-10">
        ...
        <section className="mt-14 md:mt-0 relative flex flex-col items-center justify-center text-center py-20 md:py-32 px-4 md:px-6">
          ...
          <Link href="/dashboard" className="mt-16 md:mt-20">
            <Button size="lg" className="animate-breathe text-lg px-8 py-6 rounded-3xl shadow-xl shadow-green-500/20 border-2 border-stone-800 dark:border-amber-200 font-bold bg-green-500 hover:bg-green-600 text-white dark:bg-green-600 dark:hover:bg-green-500">
